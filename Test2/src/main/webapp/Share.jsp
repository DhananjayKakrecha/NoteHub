	...
	<div class="container-fluid hero">
		<div class="row">
			<div class="col-lg-3">
				...
				<a href="./Archive.jsp"><div
						class="section3 menu-section">
			...
			<div class="col-lg-9 label-col">
				<div class="label-section">
					<form action="share" method="post" class="label-form">
						...
						<input type="hidden" name="sender" value="<%=uname%>" /> <input
							type="hidden" name="nid" value="<%=nid%>" />
