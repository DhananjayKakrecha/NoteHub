<%@page import="java.util.List"%> <%@page import="com.download.NotesDAO"%> <%@
...
<html lang="en">
  ...
  <body>
    ...
    uname.strip(); int nid = Integer.parseInt(request.getParameter("nid")); %>
    <header>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 label-col">
          <div class="label-section">
            <form action="share" method="post" class="label-form">
              <div class="create-label">
                <input placeholder="Send To" name="receiver" required />
              </div>
              <input type="hidden" name="sender" value="<%=uname%>" />
