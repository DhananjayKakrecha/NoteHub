		...
		<div class="row">
			<div class="col-lg-3">
				...
				<div class="bookmark-section menu-section">
					<img src="./resources/asterisk.svg" alt="" height="18px"
						width="18px">
					<p>High Weithage</p>
				</div>
				<div class="bookmark-section menu-section">
					...
					<div class="row">
						...
						<div class="col-lg-3 note">
							<div class="note-head">
								...
								%>
								<div class="bookmark">
									<img src="./resources/bookmark-dash.svg" alt="" height="20px"
										width="20px">
								</div>
								<%
								}
								...
								<div class="pinlogo">
									...
									<form method="post" action="pin">
										...
										<input type="hidden" name="fileName"
											value="<%=note.getFileName()%>"> <input
											type="hidden" name="searchFilter" value="<%=search%>">
							...
							<div class="operation">
								...
								<form action="pin" method="post" class="labelform">
									...
									<input type="hidden" name="fileName"
										...
										name="action" value="pinlabel"> <select name="label"
										class="select-label">
										<%
										for (String list : lists) {
