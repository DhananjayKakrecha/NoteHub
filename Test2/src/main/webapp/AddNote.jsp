      ...
      <div class="contianer-fluid nav-bar">
        <div class="row nav-row">
          ...
          <div class="col-lg-6 col-md-10 search-bar">
            <form action="SearchResult.jsp?username=${username}" method="post" class="search-form">
          ...
          <div class="col-lg-3 nav-items">
            <button type="button" class="btn btn-warning"><a href="./Inbox.jsp">Inbox</a></button>
            <div class="dropdown">
              <button
            ...
            <button type="button" class="btn btn-warning"><a href="./Login.jsp">Log Out</a></button>
          </div>
        </div>
      </div>
    </header>
    <div class="container-fluid">
      <div class="row">
		...
		<%
		    ...
		    %>
		<a href="./Batman.jsp?username=<%=username%>&label=<%=list%>">
			<div class="section2 menu-section">
				<img src="./resources/tag.svg" alt="Notes" height="48px"
					width="24px">
				<p><%= list%></p>
				<form action="pinNote" method="post">
					<input type="hidden" name="userName" value="<%= username%>">
					<input type="hidden" name="label" value="<%= list%>"> <input
        ...
        <div class="col-lg-9 addNote-col">
          <div class="addnote-section">
            <form action="addNote?username=<%= username%>" method="post" class="addnote-form">
