            ...
            <form class="row g-3" action="upload" method="post" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                ...
                <input
                  ...
                  id="exampleDataList"
                  placeholder="Subject Name in short (Ex OS,INS)"
                  name = "subject"
                  required
                />
              ...
              <div class="col-md-6">
                ...
                <select id="inputState" class="form-select" name="notetype" required>
              ...
              <div class="col-md-4">
                ...
                <select id="inputState" class="form-select" name="weightage" required>
              ...
              <div class="col-md-4">
                ...
                <select id="inputState" class="form-select" name="unit" required>
